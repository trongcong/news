...
public class NewsSaveBookMarkAdapter extends ArrayAdapter {
    ...
    public NewsSaveBookMarkAdapter(Context context, int resource, ArrayList<Post> arrPost, LoadNews loadNews) {
